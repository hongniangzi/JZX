<?php /*a:5:{s:58:"D:\WWW\DEMO\application\admin\view\Rule\authorityList.html";i:1600247942;s:51:"D:\WWW\DEMO\application\admin\view\base\common.html";i:1615018562;s:53:"D:\WWW\DEMO\application\admin\view\Public\header.html";i:1614912062;s:51:"D:\WWW\DEMO\application\admin\view\Public\left.html";i:1600158584;s:53:"D:\WWW\DEMO\application\admin\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<ul class="out">
    ...
    <div class="rbox">
        ...
        <div class="ctr">
			<a href="<?php echo url('/rule/setAuthority',array('pid'=>$pid)); ?>" class="add">新增规则</a>
		</div>
        <div class="btm">
            <table class="table01" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><a href="<?php echo url('/rule/authorityList',array('pid'=>$doc['id'])); ?>"><?php echo htmlentities($doc['title']); ?></a></td>
                    <td><?php echo htmlentities($doc['route']); ?></td>
                    <td><?php echo htmlentities($doc['type']); ?></td>
                    <td>
                        <?php if($doc['route_type']==1): ?>
                        仅栏目
                        <?php elseif($doc['route_type']==2): ?>
                        仅动作
                        <?php elseif($doc['route_type']==3): ?>
                        栏目/动作
                        <?php endif; ?>
                    </td>
                    <td><?php echo $doc['status']==1 ? '启用' : '禁用'; ?></td>
                    <td><?php echo htmlentities($doc['level']); ?></td>
                    <td><?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($doc['create_time'])? strtotime($doc['create_time']) : $doc['create_time'])); ?></td>
                    <td><?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($doc['update_time'])? strtotime($doc['update_time']) : $doc['update_time'])); ?></td>
                    <td>
                        <a href="<?php echo url('/rule/editAuthority',array('id'=>$doc['id'])); ?>">编辑</a>
                        <a href="javascript:;" onclick="if(confirm('您确定要删除吗?')){ $(this).attr('href',`<?php echo url('/rule/authorityDlete',array('id'=>$doc['id'])); ?>`)}">删除</a>
                    </td>
                </tr>
