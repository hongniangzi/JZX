<?php /*a:5:{s:58:"D:\WWW\DEMO\application\admin\view\system\configValue.html";i:1600074290;s:51:"D:\WWW\DEMO\application\admin\view\base\common.html";i:1615018562;s:53:"D:\WWW\DEMO\application\admin\view\Public\header.html";i:1614912062;s:51:"D:\WWW\DEMO\application\admin\view\Public\left.html";i:1600158584;s:53:"D:\WWW\DEMO\application\admin\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<ul class="out">
    ...
    <div class="rbox">
        <div class="top">
            ...
            <div class="links">
                [
                <a href="<?php echo url('/system/configValue'); ?>" <?php if($group_id==''): ?>class="hov"<?php endif; ?>>全部</a>
                <?php $_result=getConfigGroup();if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?>
                    <a href="<?php echo url('/system/configValue',array('group'=>$group[0])); ?>" <?php if($group[0] == $group_id): ?>class="hov"<?php endif; ?>><?php echo htmlentities($group[1]); ?></a>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                ]
            </div>
        </div>
        <div class="ctr">
            <a href="<?php echo url('/system/addConfigValue'); ?>" class="add">新增配置</a>
            <div class="seach">
            ...
            <form>
                <table class="table01" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo url('/system/addConfigValue',array('id'=>$doc['id'])); ?>"><?php echo htmlentities($doc['name']); ?></a></td>
                        <td><?php echo htmlentities($doc['title']); ?></td>
                        <td><?php echo htmlentities(getConfigGroup($doc['group'])); ?></td>
                        <td><?php echo htmlentities(getConfigType($doc['type'])); ?></td>
                        <td>
                            <a href="<?php echo url('/system/addConfigValue',array('id'=>$doc['id'])); ?>">编辑</a>
                            <a href="<?php echo url('/system/delConfigValue',array('id'=>$doc['id'])); ?>" onclick="return confirm('您确定要删除吗?');">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </table>
