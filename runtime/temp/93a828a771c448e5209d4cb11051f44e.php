<?php /*a:5:{s:57:"D:\WWW\DEMO\application\admin\view\column\columnEdit.html";i:1615018699;s:51:"D:\WWW\DEMO\application\admin\view\base\common.html";i:1615018562;s:53:"D:\WWW\DEMO\application\admin\view\Public\header.html";i:1614912062;s:51:"D:\WWW\DEMO\application\admin\view\Public\left.html";i:1600158584;s:53:"D:\WWW\DEMO\application\admin\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <form id="myForm">
                <table border="0" cellpadding="0" cellspacing="0" class="table02" width="400">
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input type="radio" name="is_release" value="1" <?php echo $info['is_release']==1 ? 'checked="true"' : ''; ?> > 允许</label>
                            &emsp;&emsp;&emsp;
                            <label><input type="radio" name="is_release" value="0" <?php echo $info['is_release']===0 ? 'checked="true"' : ''; ?> > 否</label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="100">封面宽度（非必填）：</td>
                        <td><input type="text" class="intxt" name="cover_width" value="<?php echo htmlentities($info['cover_width']); ?>"  placeholder="支持缩放后的比列(宽)"></td>
                    </tr>
                    <tr>
                        <td align="right" width="100">封面高度（非必填）：</td>
                        <td><input type="text" class="intxt" name="cover_height" value="<?php echo htmlentities($info['cover_height']); ?>" placeholder="支持缩放后的比列(高)"></td>
                    </tr>
                    <tr>
                        <td align="right" width="100">封面提示：</td>
                        <td><input type="text" class="intxt" name="cover_img_tips" value="<?php echo htmlentities($info['cover_height']); ?>"></td>
                    </tr>
                    <tr>
