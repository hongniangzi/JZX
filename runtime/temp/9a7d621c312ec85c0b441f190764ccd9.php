<?php /*a:5:{s:63:"D:\WWW\DEMO\application\admin\view\Rule\authorityGroupList.html";i:1600148732;s:51:"D:\WWW\DEMO\application\admin\view\base\common.html";i:1615018562;s:53:"D:\WWW\DEMO\application\admin\view\Public\header.html";i:1614912062;s:51:"D:\WWW\DEMO\application\admin\view\Public\left.html";i:1600158584;s:53:"D:\WWW\DEMO\application\admin\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<ul class="out">
    ...
    <div class="rbox">
        ...
        <div class="ctr">
				<a href="<?php echo url('/rule/authorityGroupAdd'); ?>" class="add">新增分组</a>
			</div>
        <div class="btm">
            <table class="table01" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities($doc['content']); ?></td>
                    <td>
                        <a href="<?php echo url('/rule/accessAuthority',array('id'=>$doc['id'])); ?>">访问授权</a>/<a href="<?php echo url('/user/listUser'); ?>">成员授权</a>
                    </td>
                    ...
                    <td>
                        <a href="<?php echo url('/rule/authorityGroupEdit',array('id'=>$doc['id'])); ?>">编辑</a>
                        <a href="javascript:;" onclick="if(confirm('您确定要删除吗?')){ $(this).attr('href',`<?php echo url('/rule/authorityGroupDlete',array('id'=>$doc['id'])); ?>`)}">删除</a>
                    </td>
                </tr>
