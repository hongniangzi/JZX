<?php /*a:5:{s:52:"D:\WWW\JZX\application\admin\view\User\listUser.html";i:1615018864;s:50:"D:\WWW\JZX\application\admin\view\base\common.html";i:1615018562;s:52:"D:\WWW\JZX\application\admin\view\Public\header.html";i:1614912062;s:50:"D:\WWW\JZX\application\admin\view\Public\left.html";i:1600158584;s:52:"D:\WWW\JZX\application\admin\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<ul class="out">
    ...
    <!-- <h3><a href="<?php echo url('/user/addUser'); ?>">新增用户</a></h3> -->
    ...
    <div class="rbox">
        ...
        <div class="ctr">
				<a href="<?php echo url('/user/addUser'); ?>" class="add">新增用户</a>
			</div>
        <div class="btm">
            <table class="table01" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities($doc['username']); ?></td>
                    <td><?php echo htmlentities($doc['login_num']); ?></td>
                    <td><?php echo htmlentities($doc['ip']); ?></td>
                    <td><?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($doc['last_login'])? strtotime($doc['last_login']) : $doc['last_login'])); ?></td>
                    ...
                    <td>
                        <a href="<?php echo url('/user/editUser',array('id'=>$doc['id'])); ?>">编辑</a>
                        <a href="javascript:;" class="edit-pwd" rel-id="<?php echo htmlentities($doc['id']); ?>">修改密码</a>
                        <a href="<?php echo url('/user/authorizationUser',array('id'=>$doc['id'])); ?>">授权分组</a>
                        <a href="javascript:;" onclick="if(confirm('您确定要删除吗?')){ $(this).attr('href',`<?php echo url('/user/dleteUser',array('id'=>$doc['id'])); ?>`)}">删除</a>
                    </td>
                </tr>
