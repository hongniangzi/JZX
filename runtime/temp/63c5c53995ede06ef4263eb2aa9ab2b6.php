<?php /*a:5:{s:61:"D:\WWW\JZX\application\admin\view\User\authorizationUser.html";i:1615018844;s:50:"D:\WWW\JZX\application\admin\view\base\common.html";i:1615018562;s:52:"D:\WWW\JZX\application\admin\view\Public\header.html";i:1614912062;s:50:"D:\WWW\JZX\application\admin\view\Public\left.html";i:1600158584;s:52:"D:\WWW\JZX\application\admin\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>用户分组授权列表</title>
...
<!--  -->
    <div class="rbox">
        <div class="top">
            <h2><?php echo htmlentities((isset($user['username']) && ($user['username'] !== '')?$user['username']:'')); ?> 所属授权分组</h2>
        </div>
        <div class="btm">
            <form id="myForm_group">
                <table border="0" cellpadding="0" cellspacing="0" class="table02" width="400">
                    <?php if(is_array($group) || $group instanceof \think\Collection || $group instanceof \think\Paginator): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$doc): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td align="right" width="20"></td>
                        <td><input type="checkbox" name="group[]" class="incheckbox" value="<?php echo htmlentities($doc['id']); ?>" title="<?php echo htmlentities($doc['content']); ?>" <?php echo explodeCheck($user['group'],$doc['id'])?'checked="checked"':''; ?>><?php echo htmlentities($doc['title']); ?></td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input type="hidden" name="id" value="<?php echo htmlentities((isset($user['id']) && ($user['id'] !== '')?$user['id']:'')); ?>">
