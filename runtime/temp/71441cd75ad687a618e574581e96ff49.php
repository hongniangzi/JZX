<?php /*a:5:{s:56:"D:\WWW\DEMO\application\admin\view\column\columnAdd.html";i:1615018674;s:51:"D:\WWW\DEMO\application\admin\view\base\common.html";i:1615018562;s:53:"D:\WWW\DEMO\application\admin\view\Public\header.html";i:1614912062;s:51:"D:\WWW\DEMO\application\admin\view\Public\left.html";i:1600158584;s:53:"D:\WWW\DEMO\application\admin\view\Public\footer.html";i:1601433002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <form id="myForm">
                <table border="0" cellpadding="0" cellspacing="0" class="table02" width="400">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="intxt" name="title_en"></td>
                    </tr>
                    <tr>
                        <td align="right" width="100">路由标识：</td>
                        <td><input type="text" class="intxt" name="rout_name"><span>（多词请使用小驼峰规则）</span></td>
                    </tr>
                    <tr>
                        <td align="right" width="100">导航显示：</td>
                        <td>
                            <label><input type="radio" name="is_nav" value="1" checked="true"> 显示</label>
                            &emsp;&emsp;&emsp;
                            <label><input type="radio" name="is_nav" value="0" > 否</label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input type="radio" name="is_release" value="1" checked="true" > 允许</label>
                            &emsp;&emsp;&emsp;
                            <label><input type="radio" name="is_release" value="0" > 否</label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="100">封面宽度：</td>
                        <td><input type="text" class="intxt" name="cover_width"  placeholder="支持缩放后的比列(宽)"></td>
                    </tr>
                    <tr>
                        <td align="right" width="100">封面高度：</td>
                        <td><input type="text" class="intxt" name="cover_height" placeholder="支持缩放后的比列(高)"></td>
                    </tr>
                    <tr>
                        <td align="right" width="100">封面提示：</td>
                        <td><input type="text" class="intxt" name="cover_img_tips"></td>
                    </tr>
                    <tr>
                        <td align="right" width="100">栏目SEO关键词（非必填）：</td>
                        <td><input type="text" class="intxt" name="site_keywords"></td>
                    </tr>
                    <tr>
                        <td align="right" width="100">栏目SEO描述（非必填）：</td>
                        <td><input type="text" class="intxt" name="site_description"></td>
                    </tr>
                    <tr>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-input-inline">
                                        <div class="layui-upload-list" style="margin:0">
                                            <img src="/static/index/images/default-img.jpg" id="srcimgurl-small-icon" class="layui-upload-img" style="width: 150px;">
                                            <input type="hidden" name="small_icon">
                                        </div>
                                    </div>
                        ...
                        <td>
                            <div class="big-icon" class="layui-upload">
                                ...
                                <div class="layui-upload-list">
                                    <input type="hidden" class="intxt" name="big_icon">
                                    <img class="layui-upload-img" id="preview-big-icon">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="description" id="" cols="40" rows="8" style="resize: none;"></textarea>
                        </td>
                    </tr>
    ...
    <script>
        layui.config({
            ...
            $('#myForm #formButton').click(function(){
                ...
                promisePost("/column/columnAdd",formData).then((res)=>{
                    if(res.status==1){
                        // 跳转
